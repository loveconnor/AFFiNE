...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('lovenotes');
    ...
    expect(workspaceService.system.appName).toEqual('lovenotes');
    ...
    expect(pageService.system.appName).toEqual('lovenotes');
