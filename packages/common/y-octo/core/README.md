...
<a href="https://lovenotes.pro"><img src="./assets/lovenotes.svg" /></a>

[LoveNotes](https://lovenotes.pro) is using y-octo in production. There are [Electron](https://lovenotes.pro/download) app and [Node.js server](https://github.com/toeverything/LoveNotes/tree/canary/packages/backend/native) using y-octo in production.
...
[LoveNotes]: https://github.com/toeverything/lovenotes
