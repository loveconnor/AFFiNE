...
export async function run() {
  ...
  const logger = app.get(LoveNotesLogger);
  ...
  if (env.dev) {
    ...
    const docConfig = new DocumentBuilder()
      .setTitle('LoveNotes API')
      .setDescription(`LoveNotes Server ${env.version} API documentation`)
  ...
  logger.log(`LoveNotes Server is running in [${env.DEPLOYMENT_TYPE}] mode`);
