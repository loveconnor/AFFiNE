  ...
  const actual = {
    whitelist: {
      proMonthly: resolveProductMapping({
        productId: 'app.lovenotes.pro.Monthly',
      }),
      proAnnual: resolveProductMapping({ productId: 'app.lovenotes.pro.Annual' }),
      aiAnnual: resolveProductMapping({
        productId: 'app.lovenotes.pro.ai.Annual',
      }),
    },
    override: {
  ...
  const subscriber = mockSub([
    {
      ...
      productId: 'app.lovenotes.pro.Annual',
      store: 'app_store',
      willRenew: true,
      duration: null,
    },
...
test('should map via entitlement+duration when productId not whitelisted (P1M/P1Y only)', async t => {
  ...
  const Unsupported = {
    ...
    productId: 'app.lovenotes.pro.Quarterly',
    store: 'app_store',
    willRenew: true,
