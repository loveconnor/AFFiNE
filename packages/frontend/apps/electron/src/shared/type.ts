...
export const AFFINE_API_CHANNEL_NAME = 'lovenotes-ipc-api';
export const AFFINE_EVENT_CHANNEL_NAME = 'lovenotes-ipc-event';
export const AFFINE_EVENT_SUBSCRIBE_CHANNEL_NAME = 'lovenotes-ipc-event-subscribe';
