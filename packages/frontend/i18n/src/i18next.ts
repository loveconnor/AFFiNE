...
import type { useLoveNotesI18N } from './i18n.gen';
...
export type I18nFuncs = ReturnType<typeof useLoveNotesI18N>;
...
export function createI18nWrapper(getI18nFn: () => i18n) {
  ...
  return new Proxy(I18nMethod, {
    ...
    ReturnType<typeof useLoveNotesI18N> & { [unknownKey: string]: () => string };
}

/**
 * I18n['com.lovenotes.xxx']({ arg1: 'hello' }) -> '中文 hello'
 */
