...
export function buildErrorResponseConfig(panel: LoveNotesAIPanelWidget) {
  return [
    {
      name: '',
      items: [
...
export function buildErrorConfig(panel: LoveNotesAIPanelWidget) {
  return {
    upgrade: () => {
...
export function buildCopyConfig(panel: LoveNotesAIPanelWidget) {
  return {
    allowed: true,
    onCopy: () => {
