...
export const container = style({
  width: '100%',
  maxWidth: cssVar('--lovenotes-editor-width'),
  marginLeft: 'auto',
  marginRight: 'auto',
  paddingLeft: cssVar('--lovenotes-editor-side-padding', '24'),
  paddingRight: cssVar('--lovenotes-editor-side-padding', '24'),
  fontSize: cssVar('--lovenotes-font-base'),
  '@container': {
...
export const title = style({
  ...
  fontSize: '15px',
  lineHeight: '24px',
  color: cssVar('--lovenotes-text-primary-color'),
});

export const showButton = style({
  height: '28px',
  borderRadius: '8px',
  border: '1px solid ' + cssVar('--lovenotes-border-color'),
...
globalStyle(`${link} .lovenotes-reference-title`, {
  borderBottom: 'none',
});
