...
// https://github.com/toeverything/blocksuite/blob/master/packages/lovenotes/components/src/icons/file-icons.ts
...
export const AttachmentFallback = ({ model, ext }: ErrorProps) => {
  ...
  const title = t['com.lovenotes.attachment.preview.error.title']();
  const subtitle = `.${ext} ${t['com.lovenotes.attachment.preview.error.subtitle']()}`;
