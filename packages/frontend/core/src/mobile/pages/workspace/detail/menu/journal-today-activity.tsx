import { MenuItem, MenuSeparator, MobileMenuSub } from '@lovenotes/component';
import { sortPagesByDate } from '@lovenotes/core/desktop/pages/workspace/detail-page/tabs/journal';
import {
  type DocRecord,
  DocService,
  DocsService,
...
const ActivityBlock = ({
  ...
  const title =
    name === 'created'
      ? t['com.lovenotes.journal.created-today']()
      : t['com.lovenotes.journal.updated-today']();
  return (
    <>
  ...
  return (
    <>
      ...
      <MobileMenuSub
        ...
        title={t['com.lovenotes.m.selector.journal-menu.today-activity']()}
      >
        {t['com.lovenotes.m.selector.journal-menu.today-activity']()}
      </MobileMenuSub>
      {suffix}
    </>
  );
