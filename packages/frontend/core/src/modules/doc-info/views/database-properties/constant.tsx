...
export const DatabaseRendererTypes = {
  ...
  link: {
    Icon: LinkIcon,
    Renderer: LinkCell,
    name: 'com.lovenotes.page-properties.property.link',
  },
  progress: {
    Icon: ProgressIcon,
    Renderer: ProgressCell,
    name: 'com.lovenotes.page-properties.property.progress',
  },
  select: {
    Icon: SingleSelectIcon,
    Renderer: SelectCell,
    name: 'com.lovenotes.page-properties.property.select',
  },
  'multi-select': {
    Icon: MultiSelectIcon,
    Renderer: MultiSelectCell,
    name: 'com.lovenotes.page-properties.property.multi-select',
  },
} as Record<
  string,
  {
