...
// map var(--lovenotes-tag-xxx) colors to var(--lovenotes-chip-label-xxx)
...
// hack: map var(--lovenotes-tag-xxx)/var(--lovenotes-chip-label-xxx) colors to var(--lovenotes-palette-line-xxx)
export const databaseTagColorToLoveNotesLabel = (color: string) => {
...
export const lovenotesLabelToDatabaseTagColor = (color: string) => {
