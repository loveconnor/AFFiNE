import { Button, IconButton, Menu } from '@lovenotes/component';
import { GlobalStateService } from '@lovenotes/core/modules/storage';
    ...
    >
      <div className={styles.card} data-animation-played={animationPlayed}>
        <p className={styles.title}>
          {t['com.lovenotes.template-journal-onboarding.title']()}
        </p>
        <Menu
        ...
        >
          <Button variant="primary" prefix={<TemplateIcon />}>
            {t['com.lovenotes.template-journal-onboarding.select']()}
          </Button>
        </Menu>
        <JournalPaper />
        <IconButton
