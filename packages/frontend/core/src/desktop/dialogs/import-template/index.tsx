...
} from '@lovenotes/core/modules/import-template';
import {
    ...
    <>
      <div className={styles.dialogContainer}>
        ...
        <h6 className={styles.mainTitle}>
          {t['com.lovenotes.import-template.dialog.createDocWithTemplate']({
            templateName,
          })}
        </h6>
        {noWorkspace ? (
      ...
      {importingError && (
        <span style={{ color: cssVar('warningColor') }}>
          {t['com.lovenotes.import-template.dialog.errorImport']()}
        </span>
      )}
      {downloadError ? (
        <span style={{ color: cssVar('warningColor') }}>
          {t['com.lovenotes.import-template.dialog.errorLoad']()}
        </span>
      ) : selectedWorkspace ? (
        <Button
        ...
        >
          {selectedWorkspaceName &&
            t['com.lovenotes.import-template.dialog.createDocToWorkspace']({
        ...
        >
          {t['com.lovenotes.import-template.dialog.createDocToNewWorkspace']()}
        </Button>
      )}
    </>
  );
