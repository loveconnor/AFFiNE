...
export const ShapeSettings = () => {
  ...
  const shapes = useMemo<RadioItem[]>(
    () => [
      ...
      },
      {
        ...
        label:
          t['com.lovenotes.settings.editorSettings.edgeless.shape.triangle'](),
      },
      {
        value: 'roundedRect',
        label:
          t[
            'com.lovenotes.settings.editorSettings.edgeless.shape.rounded-rectangle'
          ](),
      },
    ],
    [t]
  ...
  const docs = useMemo<RadioItem[]>(
    () => [
      {
        value: 'shape',
        label: t['com.lovenotes.settings.editorSettings.edgeless.shape.list'](),
      },
      {
        value: 'flow',
        label: t['com.lovenotes.settings.editorSettings.edgeless.shape.flow'](),
      },
    ],
    [t]
  );
  ...
  return (
    <>
      <EdgelessSnapshot
        key={currentDoc}
        title={t['com.lovenotes.settings.editorSettings.edgeless.shape']()}
        docName={currentDoc}
      ...
      <SettingRow
        name={t[
          'com.lovenotes.settings.editorSettings.edgeless.shape.fill-color'
        ]()}
        desc={''}
      >
        {fillColor ? (
      ...
      <SettingRow
        name={t[
          'com.lovenotes.settings.editorSettings.edgeless.shape.border-color'
        ]()}
        desc={''}
      >
        {strokeColor ? (
      ...
      <SettingRow
        name={t[
          'com.lovenotes.settings.editorSettings.edgeless.shape.border-style'
        ]()}
        desc={''}
      >
        <RadioGroup
      ...
      <SettingRow
        name={t[
          'com.lovenotes.settings.editorSettings.edgeless.shape.border-thickness'
        ]()}
        desc={''}
      >
        <Slider
