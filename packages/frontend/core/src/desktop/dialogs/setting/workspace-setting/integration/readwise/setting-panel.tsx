...
import {
  IntegrationService,
  IntegrationTypeIcon,
} from '@lovenotes/core/modules/integration';
...
const ReadwiseSettingHeader = ({ action }: { action?: ReactNode }) => {
  ...
  return (
    <IntegrationSettingHeader
      ...
      name={t['com.lovenotes.integration.readwise.name']()}
      desc={t['com.lovenotes.integration.readwise.desc']()}
      action={action}
    />
  );
};
  ...
  return (
    <li>
      <IntegrationSettingToggle
        ...
        name={t['com.lovenotes.integration.readwise.setting.sync-new-name']()}
        desc={t['com.lovenotes.integration.readwise.setting.sync-new-desc']()}
        onChange={toggle}
      />
    </li>
  );
  ...
  const strategies = useMemo(
    () =>
      [
        {
          name: t[
            'com.lovenotes.integration.readwise.setting.update-append-name'
          ](),
          desc: t[
            'com.lovenotes.integration.readwise.setting.update-append-desc'
          ](),
          value: 'append',
        },
        {
          name: t[
            'com.lovenotes.integration.readwise.setting.update-override-name'
          ](),
          desc: t[
            'com.lovenotes.integration.readwise.setting.update-override-desc'
          ](),
          value: 'override',
        },
    ...
    <>
      <li>
        <IntegrationSettingToggle
          ...
          name={t['com.lovenotes.integration.readwise.setting.update-name']()}
          desc={t['com.lovenotes.integration.readwise.setting.update-desc']()}
          onChange={toggle}
        />
      </li>
      <li
      ...
      >
        <div className={styles.updateStrategyGroupContent}>
          <h6 className={styles.updateStrategyLabel}>
            {t['com.lovenotes.integration.readwise.setting.update-strategy']()}
          </h6>
          <IntegrationSettingTextRadioGroup
            items={strategies}
            checked={updateStrategy}
...
const StartImport = ({ onImport }: { onImport: () => void }) => {
  ...
  return (
    <IntegrationSettingItem
      name={t['com.lovenotes.integration.readwise.setting.start-import-name']()}
      desc={t['com.lovenotes.integration.readwise.setting.start-import-desc']()}
    >
      <Button onClick={handleImport}>
        {t['com.lovenotes.integration.readwise.setting.start-import-button']()}
      </Button>
    </IntegrationSettingItem>
  );
};
  ...
  return (
    <li>
      <h6 className={styles.tagsLabel}>
        {t['com.lovenotes.integration.readwise.setting.tags-label']()}
      </h6>
      <WorkspaceTagsInlineEditor
        placeholder={
          <span className={styles.tagsPlaceholder}>
            {t['com.lovenotes.integration.readwise.setting.tags-placeholder']()}
          </span>
        }
