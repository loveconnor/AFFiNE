...
export const EmptyDocs = ({
  ...
  return (
    <EmptyLayout
      ...
      title={t['com.lovenotes.empty.docs.title']()}
      description={
        type === 'trash'
          ? t['com.lovenotes.empty.docs.trash-description']()
          : t['com.lovenotes.empty.docs.all-description']()
      }
      action={
        allowCreate && showActionButton ? (
          <ActionButton onClick={onCreate} prefix={<AllDocsIcon />}>
            {t['com.lovenotes.empty.docs.action.new-doc']()}
          </ActionButton>
        ) : null
      }
      {...props}
