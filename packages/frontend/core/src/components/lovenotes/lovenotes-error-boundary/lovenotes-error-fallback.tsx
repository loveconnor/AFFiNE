...
export interface LoveNotesErrorFallbackProps extends FallbackProps {
...
export const LoveNotesErrorComponent = () => {
  ...
  return (
    <ErrorDetail
      title={t['com.lovenotes.error.unexpected-error.title']()}
      resetError={reloadPage}
      buttonText={t['com.lovenotes.error.reload']()}
      description={
