...
import { InvitationService } from '@lovenotes/core/modules/cloud';
import {
  type Notification,
  NotificationListService,
  NotificationType,
} from '@lovenotes/core/modules/notification';
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <span>{t['com.lovenotes.rootAppSidebar.notifications']()}</span>
        {notifications.length > 0 && (
          <Menu
            items={
              <MenuItem prefixIcon={<DeleteIcon />} onClick={handleDeleteAll}>
                <span>{t['com.lovenotes.notification.delete-all']()}</span>
              </MenuItem>
            }
          >
      ...
      <Scrollable.Root className={styles.scrollRoot}>
        <Scrollable.Viewport className={styles.scrollViewport}>
          ...
          >
            {hasMore ? t['com.lovenotes.notification.loading-more']() : null}
          </div>
        </Scrollable.Viewport>
  ...
  return (
    <div className={styles.listEmpty}>
      ...
      <div className={styles.listEmptyTitle}>
        {t['com.lovenotes.notification.empty']()}
      </div>
      <div className={styles.listEmptyDescription}>
        {t['com.lovenotes.notification.empty.description']()}
      </div>
    </div>
  );
};
  ...
  return type === NotificationType.Mention ? (
    ...
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemNotSupported}>
        {t['com.lovenotes.notification.unsupported']()} ({type})
      </div>
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.mention'}
            components={{
              1: (
                <b
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation-review-request'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation-review-declined'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation-review-approved'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
        ...
        {!workspaceInactived && (
          ...
          >
            {t[
              'com.lovenotes.notification.invitation-review-approved.open-workspace'
            ]()}
          </Button>
        )}
        <div className={styles.itemDate}>
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation-accepted'}
            components={{
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation-blocked'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
      ...
      .then(async value => {
        if (value === false) {
          ...
          notify.error({
            ...
            message: t['com.lovenotes.expired.page.new-subtitle'](),
          });
          notificationListService
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.invitation'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
        ...
        {!workspaceInactived && (
          <Button
            ...
            loading={isAccepting}
          >
            {t['com.lovenotes.notification.invitation.accept']()}
          </Button>
        )}
        <div className={styles.itemDate}>
          {i18nTime(notification.createdAt, {
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.comment'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.lovenotes.notification.comment-mention'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
