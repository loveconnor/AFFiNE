...
const useKeyboardShortcutsI18N = () => {
  ...
  return useCallback(
    (key: KeyboardShortcutsI18NKeys) =>
      t[`com.lovenotes.keyboardShortcuts.${key}`](),
    [t]
  );
};
...
const useHeadingKeyboardShortcutsI18N = () => {
  const t = useI18n();
  return useCallback(
    (number: string) => t['com.lovenotes.keyboardShortcuts.heading']({ number }),
    [t]
  );
};
...
export const useMarkdownShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.lovenotes.shortcutsTitle.markdownSyntax'](),
    shortcuts,
  };
};
...
export const usePageShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.lovenotes.shortcutsTitle.page'](),
    shortcuts,
  };
};
...
export const useEdgelessShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.lovenotes.shortcutsTitle.edgeless'](),
    shortcuts,
  };
};
...
export const useGeneralShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.lovenotes.shortcutsTitle.general'](),
    shortcuts,
  };
};
