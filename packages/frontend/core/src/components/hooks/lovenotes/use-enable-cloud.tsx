...
export const useEnableCloud = () => {
  ...
  const confirmEnableCloud = useCallback(
    (ws: Workspace, options?: ConfirmEnableCloudOptions) => {
      ...
      openConfirmModal(
        {
          title: t['Enable LoveNotes Cloud'](),
          description: t['Enable LoveNotes Cloud Description'](),
          cancelText: t['com.lovenotes.enableLoveNotesCloudModal.button.cancel'](),
          confirmText:
          ...
          confirmButtonOptions: {
            variant: 'primary',
            ['data-testid' as string]: 'confirm-enable-lovenotes-cloud-button',
          },
          onConfirm: async () =>
