...
export const ChangePasswordPage: FC<{
  ...
  return (
    <AuthPageContainer
      title={
        hasSetUp
          ? t['com.lovenotes.auth.reset.password.page.success']()
          : t['com.lovenotes.auth.reset.password.page.title']()
      }
      subtitle={
        hasSetUp
          ? t['com.lovenotes.auth.sent.reset.password.success.message']()
