...
export const dayCell = style({
  ...
  selectors: {
    ...
    '&::before': {
      boxShadow: '0 0 0 2px var(--lovenotes-brand-color)',
    },
    '&::after': {
...
export const dayCellWeek = style({
  ...
  whiteSpace: 'nowrap',
  overflow: 'hidden',
  color: 'var(--cell-color, var(--lovenotes-text-secondary-color))',
});
export const dayCellDate = style({
  ...
  color: 'var(--cell-color, var(--lovenotes-text-primary-color))',
});
