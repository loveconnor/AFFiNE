...
import * as styles from './lovenotes-icon-picker.css';
...
export const LoveNotesIconPicker = ({
  onSelect,
}: {
              ...
              <div className={pickerStyles.groupGrid}>
                {recentIcons.map(iconName => (
                  <IconButton
                    ...
                    key={iconName}
                    icon={
                      <LoveNotesIconRenderer style={{ color }} name={iconName} />
                    }
              ...
              {filteredIcons.map(icon => {
                return (
                  <IconButton
                    ...
                    key={icon.name}
                    icon={
                      <LoveNotesIconRenderer style={{ color }} name={icon.name} />
                    }
