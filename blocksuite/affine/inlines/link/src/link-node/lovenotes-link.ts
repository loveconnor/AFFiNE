...
export class LoveNotesLink extends WithDisposable(ShadowlessElement) {
  static override styles = css`
    lovenotes-link a:hover [data-v-text='true'] {
  ...
  // see https://github.com/toeverything/LoveNotes/issues/1540
  ...
  override render() {
    ...
    if (this.delta.attributes && this.delta.attributes?.code) {
      const codeStyle = lovenotesTextStyles(this.delta.attributes);
    ...
    const style = this.delta.attributes
      ? lovenotesTextStyles(this.delta.attributes, linkStyle)
      : {};
