...
const progressColors = {
  empty: 'var(--lovenotes-black-10)',
  processing: 'var(--lovenotes-processing-color)',
  success: 'var(--lovenotes-success-color)',
};
...
export class ProgressCell extends BaseCellRenderer<number, number> {
  ...
  protected override render() {
    ...
    const bgStyles = styleMap({
      backgroundColor:
        progress === 0 ? progressColors.empty : 'var(--lovenotes-hover-color)',
    });
