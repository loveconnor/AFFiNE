...
const styles = css`
  ...
  lovenotes-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  lovenotes-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'lovenotes-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
