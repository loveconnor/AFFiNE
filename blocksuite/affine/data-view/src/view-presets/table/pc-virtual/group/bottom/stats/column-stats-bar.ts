  ...
  protected override render() {
    ...
    return html`
      ${repeat(
        ...
        col => col.id,
        col => {
          return html`<lovenotes-database-virtual-column-stats-cell
            .column=${col}
            .group=${this.group}
          ></lovenotes-database-virtual-column-stats-cell>`;
        }
      )}
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'lovenotes-database-virtual-column-stats': VirtualDataBaseColumnStats;
  }
}
