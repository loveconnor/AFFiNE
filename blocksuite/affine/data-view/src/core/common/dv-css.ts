...
export const dataViewVars = {
  cellTextSize: '--lovenotes-data-view-cell-text-size',
  cellTextLineHeight: '--lovenotes-data-view-cell-text-line-height',
};
...
export const shadow2 = css({
  boxShadow: 'var(--lovenotes-shadow-2)',
});

export const dividerH = css({
  height: '1px',
  backgroundColor: 'var(--lovenotes-divider-color)',
  margin: '8px 0',
});
