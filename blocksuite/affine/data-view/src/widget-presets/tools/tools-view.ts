...
const styles = css`
  ...
  .toolbar-hover-container:hover .lovenotes-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
  .toolbar-hover-container:has(.active) .lovenotes-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
...
export class DataViewHeaderTools extends WidgetBase {
  ...
  override render() {
    const classList = classMap({
      ...
      'lovenotes-database-toolbar': true,
    });
