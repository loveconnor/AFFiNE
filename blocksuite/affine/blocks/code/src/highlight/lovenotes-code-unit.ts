...
export class LoveNotesCodeUnit extends ShadowlessElement {
  get codeBlock() {
    return this.closest('lovenotes-code');
  }
  ...
  override render() {
    ...
    let style = this.delta.attributes
      ? lovenotesTextStyles(this.delta.attributes)
      : {};
...
declare global {
  interface HTMLElementTagNameMap {
    'lovenotes-code-unit': LoveNotesCodeUnit;
  }
}
