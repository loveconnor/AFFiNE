import { toEdgelessEmbedBlock } from '@blocksuite/lovenotes-block-embed';
import {
  EdgelessCRUDIdentifier,
  reassociateConnectorsCommand,
} from '@blocksuite/lovenotes-block-surface';
import { type AliasInfo } from '@blocksuite/lovenotes-model';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export class EmbedEdgelessSyncedDocBlockComponent extends toEdgelessEmbedBlock(
  ...
  @query('.lovenotes-embed-synced-doc-edgeless-header-wrapper')
  accessor headerWrapper: HTMLDivElement | null = null;

  @query('lovenotes-preview-root')
    ...
    return this.renderEmbed(
      () => html`
        <div
          ...
          ?data-scale=${scale}
        >
          <div class="lovenotes-embed-synced-doc-edgeless-header-wrapper">
            ${header}
          </div>
          ...
          <div class="lovenotes-embed-synced-doc-editor-overlay"></div>
        </div>
      `
    );
  };
