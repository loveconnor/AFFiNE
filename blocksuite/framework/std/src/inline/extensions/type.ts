...
export type InlineMarkdownMatchAction<
  // @ts-expect-error We allow to covariance for LoveNotesTextAttributes
  in LoveNotesTextAttributes extends BaseTextAttributes = BaseTextAttributes,
> = (props: {
...
export type InlineMarkdownMatch<
  LoveNotesTextAttributes extends BaseTextAttributes = BaseTextAttributes,
> = {
  name: string;
  pattern: RegExp;
  action: InlineMarkdownMatchAction<LoveNotesTextAttributes>;
};
