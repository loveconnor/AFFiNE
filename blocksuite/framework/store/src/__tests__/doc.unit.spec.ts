...
test('query', () => {
  ...
  const page = store1.addBlock('lovenotes:page');
  const note = store1.addBlock('lovenotes:note', {}, page);
  const paragraph1 = store1.addBlock('lovenotes:paragraph', {}, note);
  const list1 = store1.addBlock('lovenotes:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('lovenotes:list' as never, {}, note);
