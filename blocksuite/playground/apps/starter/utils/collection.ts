import type { StoreExtensionManager } from '@blocksuite/lovenotes/ext-loader';
import { LoveNotesSchemas } from '@blocksuite/lovenotes/schemas';
import { nanoid, Schema, Transformer } from '@blocksuite/lovenotes/store';
import {
  createAutoIncrementIdGenerator,
  type DocCollectionOptions,
  TestWorkspace,
} from '@blocksuite/lovenotes/store/test';
import {
  type BlobSource,
  ...
  IndexedDBBlobSource,
  MemoryBlobSource,
} from '@blocksuite/lovenotes/sync';
...
export function createStarterDocCollection(
  ...
  window.blockSchemas = LoveNotesSchemas;
